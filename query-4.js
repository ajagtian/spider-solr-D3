 var w = window.innerWidth*0.68*0.95;
   ...
   var svgContainer = d3.select("#query-4")
      .style("height", h+"px");
    
   var svg = d3.select("#query-4").append("svg")
   ...
   var mainNote = svg.append("text")
    ...
    .style("fill", "#888888")
    .text(function(d) {return "Query 4 Demonstration on a smaller data set.";});   
    ...
    resetBubbles = function () {
      ...
      d3.select("#bubbleItemNote").text("Query 4 Demonstration on a smaller data set.");
